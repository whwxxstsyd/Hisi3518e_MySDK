#ifndef		__TASK_UPGRADE_H__
#define		__TASK_UPGRADE_H__
...
class CTaskUpgrade: public CTaskBase
{
    public:
		static CTaskUpgrade *getInstance()
		{
			static CTaskUpgrade *obj = NULL;
			if (NULL == obj)
			{
				obj = new CTaskUpgrade();		
			}
			return obj;
		}	
