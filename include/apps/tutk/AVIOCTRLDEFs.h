...
typedef enum 
{
	...
	//qqb add   status led
	IOTYPE_USER_IPCAM_GET_WIFI_STATUS_LED_REQ		= 0x9600,
	IOTYPE_USER_IPCAM_GET_WIFI_STATUS_LED_RESP		= 0x9601,
	IOTYPE_USER_IPCAM_SET_WIFI_STATUS_LED_REQ			= 0x9602,
	IOTYPE_USER_IPCAM_SET_WIFI_STATUS_LED_RESP		= 0x9603,
	//ir led
	IOTYPE_USER_IPCAM_GET_IR_STATUS_LED_REQ			= 0x9604,
	IOTYPE_USER_IPCAM_GET_IR_STATUS_LED_RESP			= 0x9605,
	IOTYPE_USER_IPCAM_SET_IR_STATUS_LED_REQ			= 0x9606,
	IOTYPE_USER_IPCAM_SET_IR_STATUS_LED_RESP			= 0x9607,

	//alarm record plan
	IOTYPE_USER_IPCAM_GET_ALARM_RECPLAN_REQ		= 0x9608,
	IOTYPE_USER_IPCAM_GET_ALARM_RECPLAN_RESP		= 0x9609,
	IOTYPE_USER_IPCAM_SET_ALARM_RECPLAN_REQ			= 0x960a,
	IOTYPE_USER_IPCAM_SET_ALARM_RECPLAN_RESP		= 0x960b,
	IOTYPE_USER_IPCAM_GET_SNAPSHOT_REQ				= 0x960c,
	IOTYPE_USER_IPCAM_GET_SNAPSHOT_RESP				= 0x960d,	

	//app setting main interface config
	IOTYPE_USER_IPCAM_GET_MAIN_CONFIG_REQ			= 0x960e,
	IOTYPE_USER_IPCAM_GET_MAIN_CONFIG_RESP			= 0x960f,
	IOTYPE_USER_IPCAM_GET_ONOFF_CONFIG_REQ			= 0x9610,
	IOTYPE_USER_IPCAM_GET_ONOFF_CONFIG_RESP			= 0x9611,
	
	/* add by liwei for video */
	...
	IOTYPE_USER_IPCAM_GET_EVENTDATE_REQ             		= 0x1000a,
	IOTYPE_USER_IPCAM_GET_EVENTDATE_RESP            		= 0x1000b,
	...
	//add by zq
	IOTYPE_USER_IPCAM_UPGRADE_REQ          			= 0x1003,
	IOTYPE_USER_IPCAM_UPGRADE_RESP          		= 0x1004,
	

	IOTYPE_USER_IPCAM_UPGRADE_DOWNLOAD_REQ          = 0x1005,
	IOTYPE_USER_IPCAM_UPGRADE_DOWNLOAD_RESP         = 0x1006,

	IOTYPE_USER_IPCAM_UPGRADE_DOWNLOAD_STOP_REQ     = 0x1007,
	IOTYPE_USER_IPCAM_UPGRADE_DOWNLOAD_STOP_RESP    = 0x1008,

	IOTYPE_USER_IPCAM_UPGRADE_PROGRESS_RESP         = 0x1009,
	IOTYPE_USER_IPCAM_UPGRADE_STATUE_RESP         	= 0x1010,
	IOTYPE_USER_CMD_MAX
	
}ENUM_AVIOCTRL_MSGTYPE;


/* add by liwei for easyn */
#define IOTYPE_USER_IPCAM_GET_TIMEZONE_REQ_EXT          0x471
#define	IOTYPE_USER_IPCAM_GET_TIMEZONE_RESP_EXT         0x472
#define	IOTYPE_USER_IPCAM_SET_TIMEZONE_REQ_EXT          0x473
#define	IOTYPE_USER_IPCAM_SET_TIMEZONE_RESP_EXT         0x474
...
//add by zq
typedef struct SMsgAVIoctrlUpgrade
{
	int reserve;
	int result;				/* 0: 请求ok， -1 fail */
	int progress;		/* 0-100  -1:下载失败 */
}SMsgAVIoctrlUpgrade;
...
{
	int issdexist;
	RECORD_PEROID recplan;
}SMsgAVIoctrlAlarmRecPlan;
...
}SMsgAVIoctrlMainInterfaceConfigResp;
...
{
	unsigned int channel;
	unsigned char wifiled;		//对应0x9600
	unsigned char irled;			//对应0x9604
	unsigned char videomode;	//对应0x372
	char reserved;
	
}SMsgAVIoctrlOnOffConfigResp;
...
typedef struct
{
    ...
    unsigned char bright; // refer to ENUM_BRIGHT_LEVEL
   unsigned char reserved[3];
} SMsgAVIoctrlSetBrightReq;

typedef struct
{
    unsigned int result; // 0: success; otherwise: failed.
   unsigned char reserved[4];
} SMsgAVIoctrlSetBrightResp;
